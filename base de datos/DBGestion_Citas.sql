DROP TYPE tipoSexo, tipoestado, tipoRazon;
...
DROP TABLE consultorios CASCADE;
...
-- CitaNumero debe de tener una longitud de 3 digios. Numero entero.
...
DROP FUNCTION searchCita(paciente VARCHAR, 
                                      medico VARCHAR, 
                                      fecha VARCHAR, 
                                      estad6o VARCHAR);
